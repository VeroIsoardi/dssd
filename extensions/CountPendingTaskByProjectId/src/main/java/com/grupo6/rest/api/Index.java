...
/**
 * Count pending tasks by project id against cloud API.
...
public class Index extends AbstractIndex {
    ...
    protected Result execute(RestAPIContext context) {
        ...
        try {
            ...
            URI uri = URI.create(API_BASE_URL + "/tasks/countPending?projectId=" + encodedProjectId);
            ...
            LOGGER.error("Failed to count tasks by project in external API", e);
